...
To date, the general picture revealed by \textit{in vitro} studies of Meis and Prep molecular function has revealed very few differences between them (see for example \cite{\cite{Moens2006}}, where they are considered interchangeably). Both can bind Pbx directly (\cite{ref}), both recognize very similar sequences (\cite{ref}), both can participate in trimeric complexes with Pbx and Hox proteins (\cite{ref}), and both can activate the transcription of promoters containing their target sequences (\cite{refs}). Only two clear differences have been established: the first is that Meis is resposive to \ac{TSA} and \ac{PKA} signalling (\cite{Huang2005}) while Prep is not. The second is that Meis is able to bind some Hox proteins directly without the participation of Pbx, while Prep is not (\cite{ref}). [check]

However, their general biological functions are quite different. The Meis mutant has hematopoietic and developmental phenotypes. Prep, in contrast, is critical at a much earlier stage than Meis in functions apparently more basal, although the Prep1 hypomorphic mutant survives to E17.5, when it dies with a phenotype somewhat similar but distinct to that of the Meis1 mutant (\cite{Ferretti2006, DiRosa2007}). One partial explanation of this functional difference is that while the Prep genes are expressed ubiquitously, Meis genes have restricted and dynamic expression domains. However, if they were completely interchangeable the expression of Meis in territories that already express Prep should be redundant. This is clearly not the case. [expandir contraste fenotipos]

The work described here provides another foundation for explaining the functional differences between Meis and Prep. The near-comprehensive catalogue of \ac{TALE} factor binding sites will be a useful resource in itself for our and other groups when considering mechanisms and mediators of Meis, Prep and Pbx effects. 
